...
public class Strawberry extends Consumables{
    CircleSector strawberry;
    Color colour = Color.red;

    public Strawberry(double gridX, double gridY, int cellSize){
        super(300);
    ...
    public void updateSprite() {
        ...
        strawberry = new CircleSector(centerX,centerY,size,45, 90, 0);
